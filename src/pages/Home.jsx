...
function Home() {
  return (
    <div className="flex flex-col min-h-screen md:block relative">
      ...
      <div className="relative flex flex-col justify-center items-center text-center min-h-[calc(100vh-16rem)] w-full px-5 md:items-start md:text-start md:min-h-screen md:justify-center">
